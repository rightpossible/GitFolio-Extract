...
class GitHubService {
    ...
    async authenticateWithBrowser() {
        ...
        try {
            ...
            const token = await this.pollForToken(deviceData.device_code, deviceData.interval || 5);
...
// Your new Client ID
GitHubService.GITHUB_CLIENT_ID = 'Ov23liW3E35YlO4J5E81';
GitHubService.SCOPES = ['repo', 'read:user'];
